...
cannot cover. Uncharted still has coordinates, but Captain A \textbf{does not
...
draw coordinates from Uncharted Sectors---draw coordinates one at a time until
you draw a coordinate that cannot be charted to your chosen route. All
matching coordinates are charted; the mismatch (and any remaining coordinates) go to
your hand. Spooling is part of Module Delta; Module Theta does not unlock
it. Engage Warp Drive is unavailable when Uncharted Sectors (and the
Sensor Grid, if Module Gamma is on) have no coordinates left to draw.

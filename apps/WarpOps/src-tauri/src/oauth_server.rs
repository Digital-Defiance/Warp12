...
//! Bind a one-shot localhost server on an ephemeral port, capture the single
//! OAuth redirect, reply with a friendly page, and hand the callback URL back
//! to the webview.
//!

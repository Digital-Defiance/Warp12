...
describe('Q-Flash scope and winning 0-0', () => {
  it('does not trigger Q-Flash when 0-0 is charted on the Neutral Zone', () => {
  ...
  it('does not trigger Q-Flash when 0-0 is charted on an opponent open trail', () => {
    const state = makeGame(
      makeRound(['a', 'b'], {
        activePlayerId: 'b',

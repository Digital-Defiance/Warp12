...
All 12 modules are now implemented or in active development. **Module Zeta (Squadrons)** introduces **team play**, which requires a rating system decision before it can be rated.
...
| Subspace Fracture | — | ✅ | ✅ | ✅ | Optional | None (FFA) |

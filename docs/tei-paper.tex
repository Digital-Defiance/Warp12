...
\item \texttt{avgValueSpread}: mean difference between the highest- and lowest-valued legal candidates under the same heuristic scorer used by the seating AI (discrimination among options).
\item \texttt{avgNearOptimalFraction}: fraction of turns where the seated AI's chosen action scored within 5\% of the top-scored legal candidate (how often ``good'' play is distinguishable from noise).
